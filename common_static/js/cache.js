...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['火速围观'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">仓库系统仍处于开发阶段，使用期间有任何问题请反馈给管理员！</p></pclass></p><p><span class="layui-red"></span></p></div>',
